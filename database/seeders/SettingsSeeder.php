    ...
    public function run(): void
    {
        if (Setting::count() == 0) {
            $data = [
                [
                    'type'      => 'general',
                    'data'      => '{"website_name": "FobiRide", "developed_by": "The Tech Shelf", "currency": "USD", "case_prefix": "CASE-"}',
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    'type'      => 'business_information',
                    'data'      => '{"company_name": "FobiRide", "company_phone": "+1234567890", "company_address": "123 Street, City", "working_days": ["Mon", "Tue", "Wed", "Thu", "Fri"], "working_hours": {"start": "09:00", "end": "17:00"}, "logo": "logo.jpg", "favicon": "favicon.ico"}',
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    ...
                    'data'      => '[{"mail_mailer": "smtp", "mail_host": "mail.mkhizersajjad.com", "mail_port": 587, "mail_username": "info@mkhizersajjad.com", "mail_password": "mail_mks@123", "mail_encryption": "tls", "mail_from_address": "info@mkhizersajjad.com", "mail_from_name": "FobiRide"}]',
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
