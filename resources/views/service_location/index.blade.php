        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Service Locations List</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Service Locations List</h4>
                            <div class="d-flex justify-content-end gap-2" bis_skin_checked="1">
                                <a href="{{ route('service-location.create') }}" class="btn btn-primary waves-effect waves-light"> <i class="bx bx-plus me-1"></i> Add New</a>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $key => $location)
                                                <tr>
                                                    ...
                                                    <td>{!! getGenStatus('general', $location->status, 'badge') !!}</td>
                                                    <td class="text-center"> <a href="{{ route('service-location.edit', $location->id) }}"><i class="bx bx-pencil"></i></a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
