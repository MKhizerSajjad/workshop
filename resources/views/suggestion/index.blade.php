            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Suggestions</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class=""><a href="javascript: void(0);">Suggestions</a></li>
                                        ...
                                        <tbody>
                                            @foreach ($data as $key => $suggestion)
                                                <tr>
                                                    ...
                                                    <td>{!! $suggestion->status == 1 ? '<span class="badge bg-primary">Active</span>' : '<span class="badge bg-success">Respond</span' !!}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
