                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class=""><a href="javascript: void(0);">Notifications</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end gap-2" bis_skin_checked="1">
                                <a href="{{ route('notification.create') }}" class="btn btn-primary waves-effect waves-light"> <i class="bx bx-plus me-1"></i> Add New</a>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $notification)
                                            <tr>
                                                ...
                                                <td>{!! $notification->status == 1 ? '<span class="badge bg-primary">Active</span>' : '<span class="badge bg-warning">Inactive</span' !!}</td>
                                                <td class="text-center"> <a href="{{ route('notification.edit', $notification->id) }}"><i class="bx bx-pencil"></i></a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    </table>
