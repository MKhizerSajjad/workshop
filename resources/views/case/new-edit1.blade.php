...
@section('content')
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            ...
                                                            <span class="btn btn-info" id="currentInspection">
                                                                @if ($data->task->inspection_diagnose == 1)
                                                                    Inspection & Diagnostics - <b class="font-size-16">{{$data->task->inspection_diagnose_amount}} {{getPayment('currency', config('app.currency'), 'badge')}}</b>
                                                                @else
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-check form-check-inline font-size-16">
                                                                        ...
                                                                        <label class="form-check-label font-size-13" for="inspection">
                                                                            ...
                                                                            Inspection and Diagnostics - <b class="font-size-16">{{$data->task->inspection_diagnose_amount}} {{getPayment('currency', config('app.currency'), 'badge')}}</b>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                <div class="row text-center d-flex justify-content-center mt-2">
                                                                    <div class="col-md-6">
                                                                        <span class="btn btn-danger font-weight-bold p-1 deleteLogModal" data-id="{{ $log->id }}" data-task-id="{{ $data->task->id }}">
                                        ...
                                        <table class="table mb-0 table">
                                            ...
                                            <tbody>
                                                ...
                                                @php
                                                    ...
                                                    $total = 0;
                                                @endphp
                                                @foreach ($data->cases as $key => $task)
                                                    @php
                                                        ++$count;
    ...
    @include('modals.case.log-delete')
@endsection
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.deleteLogModal', function(){
           ...
           // Dynamically update the form's action attribute
            var actionUrl = "{{ route('case.logDelete', ['task' => ':taskId', 'log_id' => ':logId']) }}";
            actionUrl = actionUrl.replace(':taskId', taskId);
            actionUrl = actionUrl.replace(':logId', id);
            $('#deleteLogForm').attr('action', actionUrl);
            // Show the modal
