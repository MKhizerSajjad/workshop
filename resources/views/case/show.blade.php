            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Case Overview</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="{{ route('case.index') }}"><a href="javascript: void(0);">Case</a></li>
                                <li class="px-1"><a href="javascript: void(0);">></a></li>
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    <h5 class="text-truncate font-size-15">{{ $data->code }}</h5>
                                    <p class="text-muted">{{ $data->model . ' ' . $data->year }}</p>
                                </div>
                            </div>
                            <div class="row task-dates">
                                <div class="col-sm-4 col-6">
                                    <div class="mt-4">
                                        ...
                                        <p class="text-muted mb-0">{{ $data->date_opened }}</p>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-6">
                                    <div class="mt-4">
                                ...
                                <div class="col-sm-4 col-6">
                                    <div class="mt-4">
                                        <h5 class="font-size-14"><i class="bx bx-check me-1 text-primary"></i> Case Status</h5>
                                        <p class="text-muted mb-0">{!! getCaseStatus('general', $data->status, 'badge') !!}</p>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-6">
                                    <div class="mt-4">
                                        <h5 class="font-size-14"><i class="bx bx-coin me-1 text-primary"></i> Payment Status</h5>
                                        <p class="text-muted mb-0">{!! getPayment('status', $data->payment_status, 'badge') !!}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <h5 class="font-size-15 mt-4">Additional Info :</h5>
                                    <p class="text-muted">{{ $data->additional_info }}</p>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <h5 class="font-size-15 mt-4">Problem Description :</h5>
                                    <p class="text-muted">{{ $data->problem_description }}</p>
                                </div>
                            </div>
                ...
                <!-- end col -->
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Technician</h4>
                                ...
                                <div class="table-responsive">
                                        ...
                                        <table class="table align-middle table-nowrap">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><h5 class="font-size-14 m-0"><a href="javascript: void(0);" class="text-dark">{{$data->technician->first_name .' '. $data->technician->last_name }}</a></h5></td>
                                                    {{-- <td>
                                                        <div>
                                    ...
                                    @else
                                        <div class="text-center text-danger">No Technician alotted yet!</div>
                                    @endif
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if($data->taskPayments && count($data->taskPayments) > 0)
                                @foreach ($data->taskPayments as $payment)
                            ...
                            @else
                                <div class="text-center mt-4 pt-2">
                                    <p class="text text-danger">No Record Found</p>
                                </div>
                            @endif
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        @if($data->media && count($data->media) > 0)
                                            @foreach ($data->media as $file)
                                                @php
                                                    $fileType = pathinfo($file->media, PATHINFO_EXTENSION); // Get the file extension
                                                    $previewContent = '';
                                                    $imagePath = '';
                                                    ...
                                                    switch ($fileType) {
                                                        ...
                                                        case 'png':
                                                        case 'gif':
                                                            $previewContent = '<img class="thumb" src="' . asset('/task/media/'. $file->media) . '" title="' . $file->media . '" width="50">';
                                                            break;
                                                        case 'mp4':
                                                        case 'avi':
                                                        case 'mov':
                                                        case 'wmv':
                                                            ...
                                                            $previewContent = '<img class="thumb" src="' . $imagePath . '" title="' . $file->media . '">';
                                                            break;
                                                        default:
                                                ...
                                                <tr>
                                                    <td style="width: 45px;">
                                                        <div class="avatar-sm">
                                                            <span class="avatar-title rounded-circle bg-transparent text-primary font-size-24">
                                                                {!! $previewContent !!}
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <h5 class="font-size-14 mb-1">
                                                            <a href="javascript: void(0);" class="text-dark">{{ $file->media }}</a>
                                                        </h5>
                                                        {{-- <small>Size : {{ number_format($file->size / 1024, 2) }} MB</small>  --}}
                                                    </td>
                                                    <td>
                                                        <div class="text-center">
                                                            <a href="{{ asset('/task/media/' . $file->media) }}" download class="text-dark">
                        ...
                        <div class="card-body">
                            ...
                            @if($data->taskComments && count($data->taskComments) > 0)
                                @foreach ($data->taskComments as $key => $comments)
                                    ...
                                    <div class="d-flex mb-4">
                                        <div class="avatar-sm">
                                            <div class="flex-shrink-0 me-3 avatar-title rounded-circle bg-primary-stub text-primary font-size-24">
                                                {{++$key}}
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 px-2">
                                            {{-- <h5 class="font-size-13 mb-1">{{ $comments->id }}</h5> --}}
