                                ...
                                <div class="card-body">
                                    <div class="mt-3">
                                        <div class="d-flex align-items-start">
                                            ...
                                            @if ($data->task->payment_status != 1)
                                                <a href="#" class="btn btn-info font-size-12 float-right" data-bs-toggle="modal"
                                                    data-bs-target="#commentsModal-{{ $data->task->id }}"><i class="bx bx-message"></i> Add
                                                    Comment</a>
                                            @endif
                                        </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <div class="row text-center d-flex justify-content-center">
                                                                        <a href="" class="btn btn-warning btn-sm px-0 py-0"><i
                                                                                class="bx bx-edit"></i></a>
                                                                        <a href="" class="btn btn-danger btn-sm px-0 py-0"><i
