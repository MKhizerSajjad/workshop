                    ...
                    <div class="row">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <p><strong>Additional Information:</strong><br>
                                                                        <span class="text-muted">{{ $data->task->additional_info ?? 'N/A' }}</span>
                                                                    </p>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <p><strong>Description of Problem/Failure:</strong><br>
                                                                        <span class="text-muted">{{ $data->task->problem_description ?? 'N/A' }}</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="col-xl-3 col-sm-3">
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('case.show', $data->task->id) }}" class="btn btn-info font-size-18" target="_blank">
                                    <i class="bx bx-bullseye"></i>
                                </a>
                                @if ($data->task->payment_status != 1)
                                    <a href="#" class="btn btn-info font-size-18" data-bs-toggle="modal" data-bs-target="#paymentModal-{{ $data->task->id }}">
                                        <i class="bx bx-euro"></i>
                                    </a>
                                    <a href="#" class="btn btn-info font-size-18" data-bs-toggle="modal" data-bs-target="#commentsModal-{{ $data->task->id }}">
                                ...
                                <div class="card-body">
                                    ...
                                    @if(count($data->task->taskPayments) > 0)
                                        <div class="mt-3">
                                            ...
                                            <div data-simplebar="init" class="mt-2 simplebar-scrollable-y" style="max-height: 120px;"><div class="simplebar-wrapper" style="margin: 0px;">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div data-simplebar="init" class="mt-2 simplebar-scrollable-y" style="max-height: 280px;"><div class="simplebar-wrapper" style="margin: 0px;">
                                            {{-- <div class="simplebar-height-auto-observer-wrapper">
                                                <div class="simplebar-height-auto-observer"></div>
                                            </div>
                                            <div class="simplebar-mask">
