...
function getCaseStatus($prefix, $status = null, $type = null)
{
    $statuses = [
        'general'=> [
            ...
            '1' => ['Pending', '<span class="badge bg-primary">Pending</span>'],
            '2' => ['Recieved', '<span class="badge bg-warning">Recieved</span>'],
            '3' => ['Inspecting', '<span class="badge bg-danger">Inspecting</span>'],
            '4' => ['Customer is being informed', '<span class="badge bg-info">Customer is being informed</span>'],
            '5' => ['Awaiting customer confirmation', '<span class="badge bg-info">Awaiting customer confirmation</span>'],
            '6' => ['Confirmed. Waiting in queue', '<span class="badge bg-info">Confirmed. Waiting in queue</span>'],
            '7' => ['Waiting for parts', '<span class="badge bg-info">Waiting for parts</span>'],
            '8' => ['Work in progress', '<span class="badge bg-info">Work in progress</span>'],
            '9' => ['On hold', '<span class="badge bg-info">On hold</span>'],
            '10' => ['Completed', '<span class="badge bg-info">Completed</span>'],
            '11' => ['Ready for collection', '<span class="badge bg-info">Ready for collection</span>'],
            '12' => ['Dispatched', '<span class="badge bg-info">Dispatched</span>'],
            '13' => ['Collected', '<span class="badge bg-info">Collected</span>'],
